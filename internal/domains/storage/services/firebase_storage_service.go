...
func (s *FirebaseStorageService) UploadFile(ctx context.Context, req types.FileUploadRequest) (*types.FileUploadResponse, error) {
...
func (s *FirebaseStorageService) UploadAvatar(ctx context.Context, file multipart.File, header *multipart.FileHeader, userID string) (*types.FileUploadResponse, error) {
...
func (s *FirebaseStorageService) UploadDocument(ctx context.Context, file multipart.File, header *multipart.FileHeader, userID, documentType string) (*types.FileUploadResponse, error) {
	return s.UploadFile(ctx, types.FileUploadRequest{
		File:        file,
		Header:      header,
		Folder:      "documents",
...
func (s *FirebaseStorageService) GetFileInfo(ctx context.Context, fileURL string) (*types.FileUploadResponse, error) {
