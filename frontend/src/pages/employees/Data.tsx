...
export const employeeProfiles: EmployeeProfile[] = [
  {
    ...
    salaryType: 'Annual',
    bonusEligible: 'Yes',
    benefits: ['Health Insurance', '401(k) Plan', 'Dental Insurance', 'Vision Insurance', 'Flexible PTO'],
    emergencyContact: { name: 'Jane Smith', relationship: 'Spouse', phone: '+1 (555) 987-6543', email: 'jane.smith@email.com' },
  ...
  },
  {
    ...
    salaryType: 'Annual',
    bonusEligible: 'Yes',
    benefits: ['Health Insurance', '401(k) Plan', 'Dental Insurance', 'Vision Insurance'],
    emergencyContact: { name: 'Tom Johnson', relationship: 'Spouse', phone: '+1 (555) 765-4321', email: 'tom.j@email.com' },
  ...
  },
  {
    ...
    emergencyContact: { name: 'Kevin Chen', relationship: 'Brother', phone: '+1 (555) 111-2222', email: 'kevin.chen@email.com' },
  ...
  },
  {
    ...
    emergencyContact: { name: 'Amy Wang', relationship: 'Sister', phone: '+1 (555) 321-9999', email: 'amy.wang@email.com' },
  ...
  },
  {
    ...
    emergencyContact: { name: 'Mark Brown', relationship: 'Brother', phone: '+1 (555) 555-1212', email: 'mark.b@email.com' },
  ...
  },
  {
    ...
    emergencyContact: { name: 'Paul Davis', relationship: 'Father', phone: '+1 (555) 777-8888', email: 'paul.d@email.com' },
  ...
  },
  {
    ...
    bonusEligible: 'Yes',
    benefits: ['Health Insurance', '401(k) Plan'],
    emergencyContact: { name: 'Linda Lee', relationship: 'Mother', phone: '+1 (555) 999-0000', email: 'linda.l@email.com' },
  ...
  },
  {
    ...
    emergencyContact: { name: 'Carlos Martinez', relationship: 'Husband', phone: '+1 (555) 333-4444', email: 'carlos.m@email.com' },
